...
DEFAULT_BASE_DIR = Path("data/news_labels")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--corpus-2023-2025",
        default=str(DEFAULT_BASE_DIR / "pre-excluded" / "news_combined_preprocessed_2023_2025_cleaned.csv"),
        help="Cleaned 2023-2025 corpus CSV.",
    )
    parser.add_argument(
        "--corpus-2026",
        default=str(DEFAULT_BASE_DIR / "pre-excluded" / "news_combined_preprocessed_2026_cleaned.csv"),
