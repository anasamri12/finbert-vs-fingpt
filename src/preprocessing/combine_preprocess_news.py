...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-glob",
        default="data/raw/news_sources/*since_2023*.csv",
    ...
    parser.add_argument(
        "--output-csv",
        default="data/news_labels/pre-cleaned/news_combined_preprocessed.csv",
        help="Output CSV path for the full cleaned dataset.",
    )
    parser.add_argument(
        "--output-csv-2023-2025",
        default="data/news_labels/pre-cleaned/news_combined_preprocessed_2023_2025.csv",
        help="Output CSV path for the cleaned 2023-2025 subset.",
    )
    parser.add_argument(
        "--output-csv-2026",
        default="data/news_labels/pre-cleaned/news_combined_preprocessed_2026.csv",
        help="Output CSV path for the cleaned 2026 subset.",
    )
    parser.add_argument(
        "--sample-output-csv",
        default="data/news_labels/pre-cleaned/news_human_label_sample_300.csv",
        help="Output CSV path for the separate human-label sample file.",
    )
    parser.add_argument(
        "--sample-output-csv-2025",
        default="data/news_labels/pre-cleaned/news_human_label_sample_2025_100.csv",
        help="Output CSV path for the 2025-only human-label sample file.",
    )
    parser.add_argument(
        "--sample-output-csv-2026",
        default="data/news_labels/pre-cleaned/news_human_label_sample_2026_200.csv",
    ...
    parser.add_argument(
        "--report-json",
        default="data/news_labels/pre-cleaned/news_combined_preprocess_report.json",
